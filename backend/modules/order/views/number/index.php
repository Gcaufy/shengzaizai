...
if ($hospital) {
    ...
    if ($inspection)
        $this->params['breadcrumbs'][] = ['label' => '医生 - ' . $inspection->name, 'url' => ['/inspection/inspection/view', 'id' => $inspection->id, 'hosp_id' => $hospital->id]];
    if ($operation)
        $this->params['breadcrumbs'][] = ['label' => '医生 - ' . $operation->name, 'url' => ['/operation/operation/view', 'id' => $operation->id, 'hosp_id' => $hospital->id]];
}
